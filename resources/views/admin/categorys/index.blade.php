            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('admin.categories.create') }}" data-title="{{ __('lang.add_new_category') }}"
                        id="add_btn" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mainModal">
                        {{ __('lang.add_new') }}
                    </a>
                </div>
            </div>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('admin.categories.show', ['category' => $item]) }}"
                                                    ...
                                                    data-title="{{ __('lang.show_category') }}" data-bs-toggle="modal"
                                                ...
                                                <a href="{{ route('admin.categories.edit', ['category' => $item]) }}"
                                                    ...
                                                    data-title="{{ __('lang.edit_category') }}" data-bs-toggle="modal"
                                                    data-bs-target="#mainModal">
                                                ...
                                                <a class="dropdown-item deleteClass"
                                                    ...
                                                    data-title="{{ __('lang.delete_category') }}" data-bs-toggle="modal"
