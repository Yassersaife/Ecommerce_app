        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('admin.admins.create') }}" data-title="{{ __('lang.add_new_admin') }}" id="add_btn"
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="{{ route('admin.admins.show', ['admin' => $item]) }}"
                                                ...
                                                <a href="{{ route('admin.admins.edit', ['admin' => $item]) }}"
                                                ...
                                                <a class="dropdown-item deleteClass"
                                                    href="{{ route('admin.admins.destroy', ['admin' => $item]) }}"
