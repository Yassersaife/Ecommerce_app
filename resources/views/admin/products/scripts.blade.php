...
<script>
    $("document").ready(function() {
        ...
        $(document).on('click', ".deleteClass", function(e) {
            e.preventDefault();
            let url = $(this).attr("href"); // Get the URL from the delete button's href
            let title = $(this).attr("data-title");
            $("#delete-modal-title").html(title);
            $("#submit_delete").attr("href", url); // Set the URL for the submit button
        });
        ...
        $(document).on('click', "#submit_delete", function(e) {
            e.preventDefault();
            let url = $(this).attr("href"); // Retrieve the stored URL
            $.ajax({
                url: url,
                method: 'DELETE',
                headers: {
                ...
                error: function(xhr) {
                    ...
                    let errorMessage = xhr.responseJSON?.error || "Please try again ...";
                    alert(errorMessage);
                },
                beforeSend: function() {
